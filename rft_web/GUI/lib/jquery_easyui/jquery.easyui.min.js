...
body.show();
opts.collapsed=false;
//opts.onExpand.call(_1a5); // this is bad... call after animate completes
_18c(_1a5);
_192(_1a5);
}
};
...
$.fn.window.defaults=$.extend({},$.fn.panel.defaults,{zIndex:9000,draggable:true,resizable:true,shadow:false,modal:false,inline:false,title:"New Window",collapsible:true,minimizable:true,maximizable:true,closable:true,closed:false});
})(jQuery);
(function($){
function _1e8(_1e9){
var t=$(_1e9);
...
p.panel("panel").animate(_2d4.expand, function(){
...
//collapsedTitle = "Alarms";
}
}
}
}
var p=$("<div></div>").appendTo(_2ce).panel({cls:"layout-expand",title:collapsedTitle,closed:true,doSize:false,tools:[{iconCls:icon,handler:function(){
_2d7(_2ce,_2cf);
return false;
}}]});
...
p.panel("panel").animate(_2db.expand,function(){
	_2b1(_2d8);//Calculate panel size before calling onexpand
